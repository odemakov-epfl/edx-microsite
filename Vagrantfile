...
# https://raw.githubusercontent.com/edx/configuration/open-release/ginkgo.master/vagrant/release/devstack/Vagrantfile
...
openedx_release = 'open-release/ginkgo.master' ## Set manually to tie this file into ginkgo
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.ssh.forward_agent = true  ## to be able to connect to staging/prod/selenium
